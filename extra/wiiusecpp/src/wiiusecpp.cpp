...
{
    X = mpAccelCalibPtr->cal_g.x + mpAccelCalibPtr->cal_zero.x ;
    Y = mpAccelCalibPtr->cal_g.y + mpAccelCalibPtr->cal_zero.y ;
    Z = mpAccelCalibPtr->cal_g.z + mpAccelCalibPtr->cal_zero.z ;
}
...
{
    return mpWiimotePtr->ir.nb_source_detect ;
}
